...
class LisboaBuildingPage {
  ...
  void fetchData() async {
    ...
    List<MovimientoContable> allMovimientos =
        (await apiService.fetchData("Alicuotas Edificio Lisboa"))
  ...
  Widget dasboard(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Alicuotas Edificio Lisboa'),
        actions: [
          CupertinoButton(
              child: const Row(
                children: [
          ...
          IconButton(
            ...
            onPressed: () {
              Get.to(() => AccountMoveForm(),
                  arguments: {'account_origin': 'Alicuotas Edificio Lisboa'});
            },
          ),
          IconButton(
